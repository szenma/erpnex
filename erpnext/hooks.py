...
website_generators = ["Product Group", "Website Product", "BOM", "Sales Partner"]
...
scheduler_events = {
	"cron": {
		...
		"45 0 * * *": [
			"erpnext.stock.reorder_product.reorder_product",
		],
	},
	"all": [
	...
	"hourly_long": [
		...
		"erpnext.stock.doctype.repost_product_valuation.repost_product_valuation.repost_entries",
...
bot_parsers = [
	"erpnext.utilities.bot.FindProductBot",
]
...
accounting_dimension_doctypes = [
	...
	"Opening Invoice Creation Tool Product",
	"Subscription",
	"Subscription Plan",
	"POS Invoice",
	"POS Invoice Product",
...
regional_overrides = {
	...
	"United Arab Emirates": {
		"erpnext.controllers.taxes_and_totals.update_productised_tax_data": "erpnext.regional.united_arab_emirates.utils.update_productised_tax_data",
	...
	"Italy": {
		"erpnext.controllers.taxes_and_totals.update_productised_tax_data": "erpnext.regional.italy.utils.update_productised_tax_data",
...
global_search_doctypes = {
	"Default": [
		...
		{"doctype": "Product Price", "index": 25},
