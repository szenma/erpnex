...
def execute():
	reports_to_delete = [
		"Requested Products To Be Ordered",
		"Purchase Order Products To Be Received or Billed",
		"Purchase Order Products To Be Received",
		"Purchase Order Products To Be Billed",
	]
