...
parentfield = {"product_code": "products", "product_group": "product_groups", "brand": "brands"}
...
def execute():
	...
	for doctype, module in doctypes.products():
		frappe.reload_doc(module, "doctype", frappe.scrub(doctype))

		child_doc = frappe.scrub(doctype) + "_product"
	...
	for doctype, apply_on in {
		"Pricing Rule Product Code": "Product Code",
		"Pricing Rule Product Group": "Product Group",
