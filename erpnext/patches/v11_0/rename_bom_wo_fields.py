...
def execute():
	...
	for doctype in ["BOM Explosion Product", "BOM Product", "Work Order Product", "Product"]:
		if frappe.db.has_column(doctype, "allow_transfer_for_manufacture"):
			...
			rename_field(doctype, "allow_transfer_for_manufacture", "include_product_in_manufacturing")
