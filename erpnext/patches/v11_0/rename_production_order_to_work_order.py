...
def execute():
	...
	frappe.rename_doc("DocType", "Production Order Product", "Work Order Product", force=True)
	...
	frappe.rename_doc(
		"Report", "Issued Products Against Production Order", "Issued Products Against Work Order", force=True
	)
	frappe.rename_doc(
