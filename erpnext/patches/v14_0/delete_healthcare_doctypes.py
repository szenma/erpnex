...
def execute():
	...
	products = frappe.get_all("Portal Menu Product", filters=[["title", "in", titles]], pluck="name")
	for product in products:
		frappe.delete_doc("Portal Menu Product", product, ignore_missing=True, force=True)
