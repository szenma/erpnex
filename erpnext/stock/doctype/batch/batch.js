...
frappe.ui.form.on('Batch', {
	setup: (frm) => {
		frm.fields_dict['product'].get_query = function(doc, cdt, cdn) {
			return {
	...
	product: (frm) => {
		// frappe.db.get_value('Product', {name: frm.doc.product}, 'has_expiry_date', (r) => {
		// 	frm.toggle_reqd('expiry_date', r.has_expiry_date);
		// });
		frappe.db.get_value('Product', {name: frm.doc.product}, ['shelf_life_in_days', 'has_expiry_date'], (r) => {
