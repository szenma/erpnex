...
class InventoryDimension(Document):
	...
	def validate_reference_document(self):
		...
		if self.reference_document in ["Batch", "Serial No", "Warehouse", "Product"]:
	...
	def get_dimension_fields(self, doctype=None):
		...
		label_start_with = ""
		if doctype in ["Purchase Invoice Product", "Purchase Receipt Product"]:
			label_start_with = "Target"
		elif doctype in ["Sales Invoice Product", "Delivery Note Product", "Stock Entry Detail"]:
