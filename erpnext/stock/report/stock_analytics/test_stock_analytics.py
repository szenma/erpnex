...
class TestStockAnalyticsReport(FrappeTestCase):
	...
	def assert_single_product_report(self, movement, expected_buckets):
	...
	def test_basic_report_functionality(self):
		...
		self.assert_single_product_report(movement, [10, 5, 15])
	...
	def test_empty_month_in_between(self):
		...
		self.assert_single_product_report(movement, [100, 50, 50, 70])
	...
	def test_multi_month_missings(self):
		...
		self.assert_single_product_report(movement, [100, 50, 50, 70, 70, 60])
