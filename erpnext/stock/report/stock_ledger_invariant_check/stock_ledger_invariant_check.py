...
def get_stock_ledger_entries(filters):
	return frappe.get_all(
		"Stock Ledger Entry",
		fields=SLE_FIELDS,
		filters={"product_code": filters.product_code, "warehouse": filters.warehouse, "is_cancelled": 0},
...
def add_invariant_check_fields(sles):
	...
	for idx, sle in enumerate(sles):
		...
		if sle.voucher_type == "Stock Reconciliation" and not sle.batch_no:
			balance_qty = frappe.db.get_value("Stock Reconciliation Product", sle.voucher_detail_no, "qty")
