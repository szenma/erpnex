...
product-warehouse combination has a future transactions.
...
Product Valuation" doctype. Every hour a scheduled job runs and processes this
queue (for up to maximum of 25 minutes)


## Queue implementation
- "Repost product valuation" (RIV) is automatically submitted from backdated transactions. (check stock_controller.py)
...
- technical detail: Entry point for whole process is "repost_entries" function in repost_product_valuation.py
