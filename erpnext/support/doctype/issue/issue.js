frappe.ui.form.on("Issue", {
	...
	timeline_refresh: function(frm) {
		if (!frm.timeline.wrapper.find(".btn-split-issue").length) {
			...
			let communication_box = frm.timeline.wrapper.find('.timeline-product[data-doctype="Communication"]');
					...
					var dialog = new frappe.ui.Dialog({
						...
						primary_action: () => {
							frm.call("split_issue", {
								...
								communication_id: e.currentTarget.closest(".timeline-product").getAttribute("data-name")
							}, (r) => {
		...
		// 			const content = $(this).parents('.timeline-product[data-doctype="Communication"]:first').find(".content").html();
