...
def make_custom_fields():
	is_zero_rated = dict(
		...
		label="Is Zero Rated",
		fieldtype="Check",
		fetch_from="product_code.is_zero_rated",
	...
	is_exempt = dict(
		...
		label="Is Exempt",
		fieldtype="Check",
		fetch_from="product_code.is_exempt",
	...
	invoice_product_fields = [
		dict(
			...
			label="Tax Code",
			fieldtype="Read Only",
			fetch_from="product_code.tax_code",
			insert_after="description",
			allow_on_submit=1,
			print_hide=1,
		),
	...
	custom_fields = {
		"Product": [
			dict(fieldname="tax_code", label="Tax Code", fieldtype="Data", insert_after="product_group"),
			dict(
				fieldname="is_zero_rated",
				label="Is Zero Rated",
				fieldtype="Check",
		...
		"Sales Invoice Product": invoice_product_fields + delivery_date_field + [is_zero_rated, is_exempt],
		"POS Invoice Product": invoice_product_fields + delivery_date_field + [is_zero_rated, is_exempt],
		"Purchase Invoice Product": invoice_product_fields,
		"Sales Order Product": invoice_product_fields,
		"Delivery Note Product": invoice_product_fields,
		"Quotation Product": invoice_product_fields,
		"Purchase Order Product": invoice_product_fields,
		"Purchase Receipt Product": invoice_product_fields,
		"Supplier Quotation Product": invoice_product_fields,
	}
