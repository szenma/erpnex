...
def make_custom_fields():
	...
	custom_fields = {
		"Product": [is_zero_rated, is_exempt],
		"Customer": [
			dict(
				fieldname="customer_name_in_arabic",
				label="Customer Name in Arabic",
		...
		"Sales Invoice Product": [is_zero_rated, is_exempt],
		"POS Invoice Product": [is_zero_rated, is_exempt],
		"Purchase Invoice Product": [is_zero_rated, is_exempt],
		"Sales Order Product": [is_zero_rated, is_exempt],
		"Delivery Note Product": [is_zero_rated, is_exempt],
		"Quotation Product": [is_zero_rated, is_exempt],
		"Purchase Order Product": [is_zero_rated, is_exempt],
		"Purchase Receipt Product": [is_zero_rated, is_exempt],
		"Supplier Quotation Product": [is_zero_rated, is_exempt],
		"Address": [
			dict(
