...
def get_data(
	...
	for security, qty in pledges.products():
		current_pledges.setdefault(security, qty)
		current_pledges[security] -= unpledges.get(security, 0.0)

	sorted_pledges = dict(sorted(current_pledges.products(), key=lambda product: product[1], reverse=True))

	count = 0
	for security, qty in sorted_pledges.products():
