...
class TestOpportunity(unittest.TestCase):
	def test_opportunity_status(self):
		doc = make_opportunity(with_products=0)
		quotation = make_quotation(doc.name)
		quotation.append("products", {"product_code": "_Test Product", "qty": 1})
	...
	def test_opportunity_product(self):
		opportunity_doc = make_opportunity(with_products=1, rate=1100, qty=2)
