...
from plaid.errors import APIError, InvalidRequestError, ProductError
...
class PlaidConnector:
	...
	def get_access_token(self, public_token):
		...
		response = self.client.Product.public_token.exchange(public_token)
	...
	def auth(self):
		try:
			...
			if e.code == "PRODUCT_LOGIN_REQUIRED":
				pass
		except APIError as e:
