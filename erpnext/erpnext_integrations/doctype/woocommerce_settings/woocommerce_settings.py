	...
	def create_delete_custom_fields(self):
		if self.enable_sync:
			create_custom_fields(
				{
					("Customer", "Sales Order", "Product", "Address"): dict(
			...
			if not frappe.get_value("Product Group", {"name": _("WooCommerce Products")}):
				product_group = frappe.new_doc("Product Group")
				product_group.product_group_name = _("WooCommerce Products")
				product_group.parent_product_group = get_root_of("Product Group")
				product_group.insert()
