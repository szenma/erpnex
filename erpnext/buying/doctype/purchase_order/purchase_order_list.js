frappe.listview_settings['Purchase Order'] = {
	...
	onload: function (listview) {
		...
		listview.page.add_menu_product(__("Close"), function () {
			listview.call_for_selected_products(method, { "status": "Closed" });
		});

		listview.page.add_menu_product(__("Reopen"), function () {
			listview.call_for_selected_products(method, { "status": "Submitted" });
		});


		listview.page.add_action_product(__("Purchase Invoice"), ()=>{
			erpnext.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Invoice");
		});

		listview.page.add_action_product(__("Purchase Receipt"), ()=>{
			erpnext.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Receipt");
		});

		listview.page.add_action_product(__("Advance Payment"), ()=>{
