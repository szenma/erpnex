...
def make_default_records():
	install_variable_docs = [
		{
			"param_name": "total_accepted_products",
			"variable_label": "Total Accepted Products",
			"path": "get_total_accepted_products",
		},
		{
		...
		{
			"param_name": "total_rejected_products",
			"variable_label": "Total Rejected Products",
			"path": "get_total_rejected_products",
		},
		{
		...
		{
			"param_name": "total_received_products",
			"variable_label": "Total Received Products",
			"path": "get_total_received_products",
		},
		{
		...
		{
			"param_name": "sq_total_products",
			"variable_label": "SQ Total Products",
			"path": "get_sq_total_products",
		},
		{
		...
		{
			"param_name": "rfq_total_products",
			"variable_label": "RFQ Total Products",
			"path": "get_rfq_total_products",
		},
		{
			"param_name": "tot_product_days",
			"variable_label": "Total Product Days",
			"path": "get_product_workdays",
		},
		{
