...
erpnext.financial_statements = {
	...
	onload: function(report) {
		...
		report.page.add_custom_menu_product(views_menu, __("Balance Sheet"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Balance Sheet', {company: filters.company});
		});

		report.page.add_custom_menu_product(views_menu, __("Profit and Loss"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Profit and Loss Statement', {company: filters.company});
		});

		report.page.add_custom_menu_product(views_menu, __("Cash Flow Statement"), function() {
			var filters = report.get_values();
