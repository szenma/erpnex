	...
	class CustomerReviews {
			...
			$('.page_content').on('click', '.btn-write-review', (e) => {
				...
				let d = new frappe.ui.Dialog({
					...
					primary_action: function() {
						...
						frappe.call({
							method: "erpnext.e_commerce.doctype.product_review.product_review.add_product_review",
							args: {
								web_product: $btn.attr('data-web-product'),
								title: data.title,
								rating: data.rating,
		...
		view_more() {
			$('.page_content').on('click', '.btn-view-more', (e) => {
				...
				frappe.call({
					method: "erpnext.e_commerce.doctype.product_review.product_review.get_product_reviews",
					args: {
						web_product: $btn.attr('data-web-product'),
						start: me.start,
						end: me.page_length
