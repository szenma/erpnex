...
erpnext.StockGridReport = class StockGridReport extends frappe.views.TreeGridReport {
	get_product_warehouse(warehouse, product) {
		if(!this.product_warehouse[product]) this.product_warehouse[product] = {};
		if(!this.product_warehouse[product][warehouse]) this.product_warehouse[product][warehouse] = {
			balance_qty: 0.0, balance_value: 0.0, fifo_stack: []
		};
		return this.product_warehouse[product][warehouse];
	}
