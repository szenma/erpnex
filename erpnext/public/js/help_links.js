...
frappe.help.help_links["Form/Purchase Order"] = [
	...
	},
	{
		...
		url:
			docsUrl +
			"user/manual/en/buying/articles/maintaining-suppliers-part-no-in-product",
	},
	{
		label: "Recurring Purchase Order",
		url: docsUrl + "user/manual/en/accounts/articles/recurring-orders-and-invoices",
...
frappe.help.help_links["List/Product"] = [
	{ label: "Product", url: docsUrl + "user/manual/en/stock/product" },
	{
		label: "Product Price",
		url: docsUrl + "user/manual/en/stock/product-price",
	},
	{
		label: "Barcode",
		url:
			docsUrl + "user/manual/en/stock/articles/track-products-using-barcode",
	},
	{
		label: "Product Wise Taxation",
		url: docsUrl + "user/manual/en/accounts/product-tax-template",
	},
	{
		label: "Managing Fixed Assets",
		url: docsUrl + "user/manual/en/asset",
	...
	{
		label: "Product Codification",
		url: docsUrl + "user/manual/en/stock/articles/product-codification",
	},
	{
		label: "Product Variants",
		url: docsUrl + "user/manual/en/stock/product-variants",
	},
	{
		label: "Product Valuation",
		url:
			docsUrl +
			"user/manual/en/stock/articles/product-valuation-fifo-and-moving-average",
	},
];

frappe.help.help_links["Form/Product"] = [
	{ label: "Product", url: docsUrl + "user/manual/en/stock/product" },
	{
		label: "Product Price",
		url: docsUrl + "user/manual/en/stock/product-price",
	...
	},
	{
		...
		url:
			docsUrl +
			"user/manual/en/stock/product/product-valuation-fifo-and-moving-average",
	},
];
...
frappe.help.help_links["Tree/Product Group"] = [
	{
		label: "Product Group",
		url: docsUrl + "user/manual/en/stock/product-group",
	},
];

frappe.help.help_links["Form/Product Attribute"] = [
	{
		label: "Product Attribute",
		url: docsUrl + "user/manual/en/stock/product-attribute",
	},
];
