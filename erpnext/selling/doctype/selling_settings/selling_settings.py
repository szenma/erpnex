...
class SellingSettings(Document):
	def on_update(self):
		...
		self.toggle_editable_rate_for_bundle_products()
	...
	def toggle_editable_rate_for_bundle_products(self):
		editable_bundle_product_rates = cint(self.editable_bundle_product_rates)

		make_property_setter(
			"Packed Product",
			"rate",
			"read_only",
			not (editable_bundle_product_rates),
			"Check",
