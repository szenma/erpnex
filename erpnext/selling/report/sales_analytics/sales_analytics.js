	...
	"filters": [
		{
			...
			label: __("Tree Type"),
			fieldtype: "Select",
			options: ["Customer Group", "Customer", "Product Group", "Product", "Territory", "Order Type", "Project"],
			default: "Customer",
			reqd: 1
		},
		{
		...
		return Object.assign(options, {
			...
			events: {
				onCheckRow: function (data) {
					...
					const data_doctype = $(
						data[2].html
					)[0].attributes.getNamedProduct("data-doctype").value;
					...
					const slice_at = { Customer: 4, Product: 5 }[tree_type] || 3;
