...
### Stock
1. [Serialized & Batched Product Reconciliation](https://erpnext.com/docs/user/manual/en/setting-up/stock-reconciliation#12-for-serialized-products)
1. [Auto Fetch Serialized Products](https://erpnext.com/version-12/release-notes/features#new-upload-dialog)
1. [Product Tax Templates](https://erpnext.com/docs/user/manual/en/accounts/product-tax-template)
...
1. [Sales Partner Target Variance based on Product Group](https://erpnext.com/docs/user/manual/en/selling/sales-partner#sales-partner-target-variance-based-on-product-group)
