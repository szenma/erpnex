...
- [Consume serialized products during Asset Repair](https://github.com/frappe/erpnext/pull/28349)

### Manufacturing
- [Faster BOM Update Tool](https://github.com/frappe/erpnext/pull/31078)
- [Scrap Product in Job Card](https://github.com/frappe/erpnext/pull/27518)
...
- [Provision to aggregate subassembly products in production plan](https://github.com/frappe/erpnext/pull/28939)
...
- [UOM specific barcode](https://docs.erpnext.com/docs/v14/user/manual/en/stock/articles/track-products-using-barcode#uom-specific-barcode)
