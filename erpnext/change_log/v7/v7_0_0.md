...
#### Improved Navigation
- Heatmaps
- Centralized navigation from Masters like Product, Customer, Supplier, Employee etc.
...
- Add opening Stock and Rate while creating a new Product
...
- Added Safety Stock to Product Master
