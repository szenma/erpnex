...
def install(country=None):
	records = [
		...
		# product group
		{
			...
			"product_group_name": _("All Product Groups"),
			"is_group": 1,
			"parent_product_group": "",
		},
		{
			"doctype": "Product Group",
			"product_group_name": _("Products"),
			"is_group": 0,
			"parent_product_group": _("All Product Groups"),
			"show_in_website": 1,
		},
		{
			"doctype": "Product Group",
			"product_group_name": _("Raw Material"),
			"is_group": 0,
			"parent_product_group": _("All Product Groups"),
		},
		{
			"doctype": "Product Group",
			"product_group_name": _("Services"),
			"is_group": 0,
			"parent_product_group": _("All Product Groups"),
		},
		{
			"doctype": "Product Group",
			"product_group_name": _("Sub Assemblies"),
			"is_group": 0,
			"parent_product_group": _("All Product Groups"),
		},
		{
			"doctype": "Product Group",
			"product_group_name": _("Consumable"),
			"is_group": 0,
			"parent_product_group": _("All Product Groups"),
		},
		# Stock Entry Type
	...
	add_uom_data()
	update_product_variant_settings()
	update_global_search_doctypes()
...
def update_selling_defaults():
	...
	selling_settings.allow_multiple_products = 1
...
def update_buying_defaults():
	...
	buying_settings.allow_multiple_products = 1
	buying_settings.save()


def update_product_variant_settings():
	# set no copy fields of an product doctype to product variant settings
...
def update_stock_settings():
	...
	stock_settings.product_naming_by = "Product Code"
