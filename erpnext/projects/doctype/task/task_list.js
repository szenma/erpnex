frappe.listview_settings['Task'] = {
	...
	onload: function(listview) {
		...
		listview.page.add_menu_product(__("Set as Open"), function() {
			listview.call_for_selected_products(method, {"status": "Open"});
		});

		listview.page.add_menu_product(__("Set as Completed"), function() {
			listview.call_for_selected_products(method, {"status": "Completed"});
		});
	},
