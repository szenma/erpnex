...
class TestTimesheet(unittest.TestCase):
	...
	def test_sales_invoice_from_timesheet(self):
		...
		sales_invoice = make_sales_invoice(
			timesheet.name, "_Test Product", "_Test Customer", currency="INR"
		)
		...
		product = sales_invoice.products[0]
		self.assertEqual(product.product_code, "_Test Product")
		self.assertEqual(product.qty, 2.00)
		self.assertEqual(product.rate, 50.00)
