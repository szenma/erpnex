...
@frappe.whitelist()
def make_sales_invoice(source_name, product_code=None, customer=None, currency=None):
	...
	if product_code:
		target.append("products", {"product_code": product_code, "qty": hours, "rate": billing_rate})
