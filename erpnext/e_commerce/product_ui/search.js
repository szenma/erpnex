erpnext.ProductSearch = class {
	...
	getRecentSearches() {
		return JSON.parse(localStorage.getProduct("recent_searches") || "[]");
	}
	...
	setRecentSearches(query) {
		...
		recents.push(query);
		localStorage.setProduct("recent_searches", JSON.stringify(recents));
	...
	populateResults(product_results) {
		...
		product_results.forEach((res) => {
			...
			html += `
				<div class="dropdown-product" style="display: flex;">
					<img class="product-thumb col-2" src=${thumbnail} />
					<div class="col-9" style="white-space: normal;">
						<a href="/${res.route}">${res.web_product_name}</a><br>
