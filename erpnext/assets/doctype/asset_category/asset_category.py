...
def get_asset_category_account(
	fieldname, product=None, asset=None, account=None, asset_category=None, company=None
):
	if product and frappe.db.get_value("Product", product, "is_fixed_asset"):
		asset_category = frappe.db.get_value("Product", product, ["asset_category"])
