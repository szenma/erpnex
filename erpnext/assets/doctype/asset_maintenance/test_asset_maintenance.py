...
class TestAssetMaintenance(unittest.TestCase):
	...
	def test_create_asset_maintenance(self):
		pr = make_purchase_receipt(
			product_code="Photocopier", qty=1, rate=100000.0, location="Test Location"
		)
...
def create_asset_data():
	...
	if not frappe.db.exists("Product", "Photocopier"):
		meta = frappe.get_meta("Asset")
		naming_series = meta.get_field("naming_series").options
		frappe.get_doc(
			{
				"doctype": "Product",
				"product_code": "Photocopier",
				"product_name": "Photocopier",
