	...
	def sync_maintenance_tasks(self):
		...
		for task in self.get("asset_maintenance_tasks"):
			...
			update_maintenance_log(
				asset_maintenance=self.name, product_code=self.product_code, product_name=self.product_name, task=task
			)
...
def update_maintenance_log(asset_maintenance, product_code, product_name, task):
