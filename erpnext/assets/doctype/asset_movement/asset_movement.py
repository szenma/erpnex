	...
	def set_latest_location_and_custodian_in_asset(self):
		...
		for d in self.assets:
			...
			latest_movement_entry = frappe.db.sql(
				"""
				SELECT asm_product.target_location, asm_product.to_employee
				FROM `tabAsset Movement Product` asm_product, `tabAsset Movement` asm
				WHERE
					asm_product.parent=asm.name and
					asm_product.asset=%(asset)s and
