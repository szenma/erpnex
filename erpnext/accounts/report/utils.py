...
@frappe.whitelist()
def get_invoiced_product_gross_margin(
	sales_invoice=None, product_code=None, company=None, with_product_data=False
):
	from erpnext.accounts.report.gross_profit.gross_profit import GrossProfitGenerator

	sales_invoice = sales_invoice or frappe.form_dict.get("sales_invoice")
	product_code = product_code or frappe.form_dict.get("product_code")
