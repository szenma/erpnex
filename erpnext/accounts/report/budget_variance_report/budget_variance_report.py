...
def execute(filters=None):
	...
	for dimension in dimensions:
		dimension_products = cam_map.get(dimension)
		if dimension_products:
			data = get_final_data(dimension, dimension_products, filters, period_month_ranges, data, 0)
...
def get_final_data(dimension, dimension_products, filters, period_month_ranges, data, DCC_allocation):
	for account, monthwise_data in dimension_products.products():
