...
class TestLoyaltyProgram(unittest.TestCase):
	@classmethod
	def setUpClass(self):
		# create relevant product, customer, loyalty program, etc
		create_records()
			...
			"products": [
				{
					...
					"product_code": frappe.get_doc("Product", {"product_name": "Loyal Product"}).name,
					"qty": qty,
					"rate": 10000,
...
def create_records():
	...
	# create an product
	if not frappe.db.exists("Product", "Loyal Product"):
		frappe.get_doc(
			{
				"doctype": "Product",
				"product_code": "Loyal Product",
				"product_name": "Loyal Product",
	...
	if not frappe.db.exists(
		"Product Price", {"price_list": "Standard Selling", "product_code": "Loyal Product"}
	):
		frappe.get_doc(
			{
