...
let do_not_include_fields = ["naming_series", "product_code", "product_name", "stock_uom", "asset_naming_series",
...
frappe.ui.form.on('POS Settings', {
	...
	add_search_options: function(frm) {
		frappe.model.with_doctype("Product", () => {
			var fields = $.map(frappe.get_doc("DocType", "Product").fields, function(d) {
...
frappe.ui.form.on("POS Search Fields", {
	field: function(frm, doctype, name) {
		...
		var df = $.map(frappe.get_doc("DocType", "Product").fields, function(d) {
