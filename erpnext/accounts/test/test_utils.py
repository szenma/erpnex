...
class TestUtils(unittest.TestCase):
	...
	def test_get_voucher_wise_gl_entry(self):
		...
		future_vouchers = get_future_stock_vouchers("2021-01-01", "00:00:00", for_products=["_Test Product"])
	...
	def test_stock_voucher_sorting(self):
		...
		stock_entry = {"product": product, "to_warehouse": "_Test Warehouse - _TC", "qty": 1, "rate": 10}
