...
$.extend(shopping_cart, {
	...
	bind_events: function() {
		...
		shopping_cart.bind_remove_cart_product();
			...
			primary_action: () => {
				...
				frappe.call({
					...
					callback: function(r) {
						d.hide();
						if (!r.exc) {
							$(".cart-tax-products").html(r.message.total);
	...
	bind_change_qty: function() {
		// bind update button
		$(".cart-products").on("change", ".cart-qty", function() {
			var product_code = $(this).attr("data-product-code");
			var newVal = $(this).val();
			shopping_cart.shopping_cart_update({product_code, qty: newVal});
		});

		$(".cart-products").on('click', '.number-spinner button', function () {
			var btn = $(this),
			...
			var product_code = input.attr("data-product-code");
	...
	bind_change_notes: function() {
		$('.cart-products').on('change', 'textarea', function() {
			const $textarea = $(this);
			const product_code = $textarea.attr('data-product-code');
	...
	bind_remove_cart_product: function() {
		$(".cart-products").on("click", ".remove-cart-product", (e) => {
			const $remove_cart_product_btn = $(e.currentTarget);
			var product_code = $remove_cart_product_btn.data("product-code");
